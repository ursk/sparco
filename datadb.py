...
class EcogDB(DB):
    ...
    def __init__(self, dims, filenames, normalize='all',
        ...
        if self.channels is not None:
            ...
            self.channels = np.arange(self.C)
        self.t = 0
...
class GautamDB(DB):
    ...
    def fetch(self):
        n = self.T * self.subsample * self.cache
        ...
        # transpose to (channels, time)
        print "transpose to (channels, time) gives", data.T.shape # [URS] never get here! 
        self.data = data.T
